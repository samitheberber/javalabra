...
class ACLI {
	...
	private void skillRemoveMenu() {
		...
		while (!state) {
			...
			System.out.print("Which skill you want to remove: ");
			if (this.avatar.removeSkill(this.avatar.searchSkill(readText())))
